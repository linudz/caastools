...
# 1. Introduction to CAAStools {#1-introduction-to-caastools}
...
## 1.1 Suite overview {#1-1-suite-overview}
...
**Figure 1**. CAAStools 1.0 overview.
...
# 2 Download, installation and updates. {#2-download-installation-and-updates}


## 2.1 Availability. {#2-1-availability}
...
## 2.3 Dependencies and software requirements. {#2-3-dependencies-and-software-requirements}
...
### Discovery and Bootstrap tools {#discovery-and-bootstrap-tools}
...
# 3. Discovery tool {#3-discovery-tool}


## 3.1 Algorithm overview {#3-1-algorithm-overview}
...
## 3.2 Formatting the inputs {#3-2-formatting-the-inputs}


### 3.2.1 The configuration file {#3-2-1-the-configuration-file}
...
### 3.2.2 The amino acid MSA {#3-2-2-the-amino-acid-msa}
...
### 3.2.3 A note on name consistency {#3-2-3-a-note-on-name-consistency}
...
## 3.3 Gaps and missing species filtering {#3-3-gaps-and-missing-species-filtering}
...
### 3.3.1 Filtering for gaps {#3-3-1-filtering-for-gaps}
...
### 3.3.2 Filtering for missing species {#3-3-2-filtering-for-missing-species}
...
## 4.1 Algorithm Overview {#4-1-algorithm-overview}
...
### 4.1.1 Random simulation strategy {#4-1-1-random-simulation-strategy}
...
### 4.1.2 Phylogeny-restricted random simulation strategy. {#4-1-2-phylogeny-restricted-random-simulation-strategy}
...
### 4.1.3 Brownian motion based simulation strategy. {#4-1-3-brownian-motion-based-simulation-strategy}
...
## 4.2 Inputs per simulation strategy {#4-2-inputs-per-simulation-strategy}
...
ct resample -p examples/phylogeny.nw -f 5 -b 4 -m ra

ndom --cycles 500 -o test/resample/random.simulation.tab
...
### Ex.2 Simulation based on BM {#ex-2-simulation-based-on-bm}
...
# 5 Bootstrap Tool {#5-bootstrap-tool}


## 5.1 Algorithm overview {#5-1-algorithm-overview}
...
## 5.2 The inputs {#5-2-the-inputs}

-s resampled trait (output of ct resample)
...
### Bootstrap from BM resampled traits. {#bootstrap-from-bm-resampled-traits}
...
Once we have published our fantastic BioRXiv or paper, you will be able to cite us.


# 7. How to contact the development team {#7-how-to-contact-the-development-team}

For any inquire, please contact Fabio Barteri fabio.barteri@upf.edu
